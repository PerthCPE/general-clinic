...
import { Patient, PastVisitRecord } from '../../types';
...
export const PatientRecordsView: React.FC<PatientRecordsViewProps> = ({
  ...
  const filteredPatients = patients.filter(p => {
    if (statusFilter === 'in_progress') {
      ...
      const isActive = p.status === 'Waiting' || p.status === 'In Progress';
      ...
      {!selectedPatient ? (
        ...
        <div className="space-y-6 animate-in fade-in duration-200">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs overflow-hidden">
            <div className="flex border-b border-slate-200 px-6 pt-3 gap-3 bg-slate-50/50">
              <button
              ...
              {activeTab === 'profile' && (
                <div className="space-y-6 text-xs">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-[#f8fafc] p-4 rounded-2xl border border-slate-200/90 space-y-3">

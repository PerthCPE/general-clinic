...
import { DocumentManagementPage } from './pages/registrar/DocumentManagementPage';
import { ScheduleManagementPage } from './pages/registrar/ScheduleManagementPage';
import { DocumentForwardPage } from './pages/registrar/DocumentForwardPage';
